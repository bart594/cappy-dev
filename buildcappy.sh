...
export CROSS_COMPILE="/home/ubu/android-toolchain-eabi/bin/arm-eabi-"

export KBUILD_BUILD_VERSION="0.6.1-talon-dev-ex"
...
rm -rf ./mod_inst
unzip ./usr/prebuilt_ko_cappy.zip -d ./usr/initrd_files/lib/modules/
