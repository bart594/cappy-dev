...
static unsigned int initial_gpio_table[][4] =
{
	...
	{S5PV210_GPB(0),  S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN},
	{S5PV210_GPB(1),  S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE},
	{S5PV210_GPB(2),  S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN},
...
#if defined(CONFIG_GALAXY_I897)
	{S5PV210_GPD1(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN},
	{S5PV210_GPD1(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN},
#else
...
#if defined(CONFIG_GALAXY_I897)
	{S5PV210_GPH2(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN},
#else
	...
	{S5PV210_GPJ2(5), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN},
#else
	...
	// MP04 --------------------------------------------------------------------
#if defined(CONFIG_GALAXY_I897)
	{S5PV210_MP04(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN},
#else
...
static unsigned int sleep_gpio_table[][3] =
{
	...
	{S5PV210_GPB(1),  S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},		//GPIO_MSENSE_nRST    	// [HDLNC] REV 03 hawk
...
//	{S5PV210_GPH0(2), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_PS_VOUT
...
#else
#if defined(CONFIG_GALAXY_I897)
	{S5PV210_GPH1(0), S3C_GPIO_OUTPUT,	S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE},
#else
	{S5PV210_GPH1(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},
#endif
#endif
...
#endif
#if defined(CONFIG_GALAXY_I897)
	{S5PV210_GPH1(2), S3C_GPIO_OUTPUT,	S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_DOWN},
#else
	...
	//{S5PV210_GPH2(1), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN},	//GPIO_KBC1
...
#if defined(CONFIG_GALAXY_I897) //hdlnc
